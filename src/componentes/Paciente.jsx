...
const Paciente = ({paciente, setPaciente, eliminarPaciente}) => {
  return (
    ...
    <div className="bg-white shadow-md mr-5 px-5 py-5 rounded mb-5">
    ...
    <div className='flex justify-between'>
      ...
      <button type="button" onClick={() => eliminarPaciente(paciente.id)} className="bg-indigo-600 p-2 w-32 ml-3 text-white font-bold uppercase hover:bg-indigo-800 cursor-pointer transition-all rounded">Eliminar</button>
    </div>
  </div>
  )
}
